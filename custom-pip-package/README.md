...
```bash
pip3.x install git+https://github.com/REPO_NAME/PROJECT_NAME.git#subdirectory=custom-pip-package
```
...
```bash
pip3.9 install --upgrade git+https://github.com/REPO_NAME/PROJECT_NAME.git#subdirectory=custom-pip-package
```
